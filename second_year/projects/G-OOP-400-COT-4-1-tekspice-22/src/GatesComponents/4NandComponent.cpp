...
#include "../../include/GatesComponents/4NandComponent.hpp"
using namespace nts;


FourNandComponent::FourNandComponent()
{}

FourNandComponent::~FourNandComponent()
{}

Tristate FourNandComponent::compute(size_t pin)
{
    ...
    pin != 4 &&
    pin != 10 &&
    pin != 11) ? throw CircuitError("Retrieve Error: Invalid pin") : ({
